...
import { View, Text, StyleSheet,Button,ImageBackground,Image, TextInput, TouchableOpacity } from 'react-native';
...
<ImageBackground
      ...
      <View style={styles.middleView} >
        ...
        <View style={styles.downView}>
             <Text style={styles.suText}>By continuing you agree to our 
        ...
        <Text style={styles.hasAccount}>Already have and account? 
